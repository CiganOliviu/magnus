class CurrentReadingCheck():
	...
	dataset = [
		...
		{id: 6, book_title: "The trouble with being born", author: "Emil Cioran", current_page: 0},
    		{id: 7, book_title: "451 Fahrenhein", author: "Ray Bradbury", current_page: 127},
		{id: 8, book_title: "Every man dies alone", author: "Hans Fallada", current_page: 0},
	]
