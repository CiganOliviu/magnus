...
class toReadBooks():
	...
	dataset = [
		...
		{id: 27, book_title: "24 Patterns for Clean Code", author: "Robert Beisert", want_level: 10, status: "owned"},
		{id: 28, book_title: "Clean Arhitecture", author: "Robert C. Martin", want_level: 10, status: "owned"},
		{id: 29, book_title: "Code Complete: A Practical Handbook of Software Construction: ", author: "Steve McConnell", want_level: 10, status: "not-owned"},
		{id: 30, book_title: "Structure and Interpretation of Computer Programs, 2nd Edition (MIT Electrical Engineering and Computer Science)", author: "Harold Abelso", want_level: 10, status: "not-owned"},
		{id: 31, book_title: "Design patterns : elements of reusable object-oriented software", author: "Erich Gamma", want_level: 10, status: "not-owned"},
		{id: 32, book_title: "Head First Design Patterns", author: "Eric Freeman", want_level: 10, status: "not-owned"},
		{id: 33, book_title: "Refactoring: Improving the Design of Existing Code (Object Technology Series)", author: "Kent Beck", want_level: 10, status: "not-owned"},
		{id: 34, book_title: "Working Effectively with Legacy Code", author: "Michael Feathers", want_level: 10, status: "not-owned"},
		{id: 35, book_title: "The Art of Computer Programming, Volumes 1-4A Boxed Set (Box Set)", author: "Donald E. Knuth", want_level: 10, status: "not-owned"},
		{id: 36, book_title: "Compilers: Principles, Techniques, and Tools", author: "Alfred V. Aho", want_level: 10, status: "not-owned"},
		{id: 37, book_title: "The Complete Software Developer's Career Guide: How to Learn Programming Languages Quickly, Ace Your Programming Interview, and Land Your Software Developer Dream Job", author: "John Sonmez", want_level: 10, status: "not-owned"},
		{id: 38, book_title: "The Pragmatic Programmer: From Journeyman to Master", author: "Andrew Hunt", want_level: 10, status: "not-owned"},
		{id: 39, book_title: "The Passionate Programmer: Creating a Remarkable Career in Software Development (Pragmatic Life)", author: "Chad Fowler", want_level: 10, status: "not-owned"},
		{id: 40, book_title: "The Mythical Man-Month: Essays on Software Engineering, Anniversary Edition", author: "Frederick P. Brooks Jr.", want_level: 10, status: "not-owned"},
		{id: 41, book_title: "Domain-Driven Design: Tackling Complexity in the Heart of Software", author: "Eric Evans", want_level: 10, status: "not-owned"},
		{id: 42, book_title: "Patterns of Enterprise Application Architecture (The Addison-Wesley Signature Series)", author: "Martin Fowler", want_level: 10, status: "not-owned"},
		{id: 43, book_title: "Enterprise Integration Patterns: Designing, Building, and Deploying Messaging Solutions (Addison-Wesley Signature Series (Fowler))", author: "Gregor Hohpe", want_level: 10, status: "not-owned"},
		{id: 44, book_title: "Refactoring to Patterns (Addison-Wesley Signature)", author: "Joshua Kerievsky", want_level: 10, status: "not-owned"},
		{id: 45, book_title: "Agile Software Development, Principles, Patterns, and Practices", author: "Robert C. Martin", want_level: 10, status: "not-owned"},
		{id: 46, book_title: "Agile Principles, Patterns, and Practices in C#", author: "Robert C. Martin", want_level: 10, status: "not-owned"},
		...
		{id: 50, book_title: "Programming Pearls (ACM Press)", author: "Jon Bentley", want_level: 10, status: "not-owned"},
		{id: 51, book_title: "Cracking the Coding Interview: 150 Programming Questions and Solutions", author: "Gayle Laakmann McDowell", want_level: 10, status: "not-owned"},
		{id: 52, book_title: "Thinking in Java, Fourth Edition", author: "Bruce Eckel", want_level: 10, status: "not-owned"},
		{id: 53, book_title: "Seven Languages in Seven Weeks: A Pragmatic Guide to Learning Programming Languages (Pragmatic Programmers)", author: "Bruce A. Tate", want_level: 10, status: "not-owned"},
		{id: 54, book_title: "C# in Depth", author: "Jon Skeet", want_level: 10, status: "not-owned"},
		{id: 55, book_title: "Testing Computer Software", author: "Cem Kaner", want_level: 10, status: "not-owned"},
		{id: 56, book_title: "Ship it!: A Practical Guide to Successful Software Projects (Pragmatic Programmers)", author: "Jared Richardson", want_level: 10, status: "not-owned"},
		{id: 57, book_title: "Continuous Delivery: Reliable Software Releases through Build, Test, and Deployment Automation (Addison-Wesley Signature)", author: "Jez Humble", want_level: 10, status: "not-owned"},
		{id: 58, book_title: "Soft Skills: The software developer's life manual", author: "John Sonmez", want_level: 10, status: "not-owned"},
		{id: 59, book_title: "Code: The Hidden Language of Computer Hardware and Software", author: "Charles Petzold", want_level: 10, status: "not-owned"},
