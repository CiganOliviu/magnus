...
class toReadBooks():
	...
	dataset = [
		...
		{id: 60, book_title: "Godel, Escher, Bach: An Eternal Golden Braid", author: "Douglas R. Hofstadter", want_level: 10, status: "owned"},
		{id: 61, book_title: "The War of Art", author: "Steven Pressfield", want_level: 10, status: "owned"},
		{id: 62, book_title: "As a Man Thinketh", author: "James Allen", want_level: 10, status: "not-owned"},
		{id: 63, book_title: "Maximum Achievement: Strategies and Skills That Will Unlock Your Hidden Powers to Succeed", author: "Brian Tracy", want_level: 10, status: "owned"},
		{id: 64, book_title: "How to Fail at Almost Everything and Still Win Big: Kind of the Story of My Life", author: "Scott Adams", want_level: 10, status: "owned"},
		{id: 65, book_title: "The Obstacle Is the Way: The Timeless Art of Turning Trials into Triumph", author: "Ryan Holiday", want_level: 10, status: "owned"},
